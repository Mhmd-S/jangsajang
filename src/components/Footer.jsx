					...
					<div className="md:col-span-4">
						<div className="flex items-center gap-4">
							...
							<div className="flex flex-col">
								...
								<span className="text-sm md:text-base text-[#2d1609]/80">
									Jangsajang Deobap
								</span>
							</div>
						</div>
						<p className="mt-4 text-sm text-[#2d1609]/70 max-w-sm">
							Authentic Korean bowls made with fresh ingredients
				...
				<div className="mt-12 pt-8 border-t border-[#2d1609]/10">
					<div className="flex flex-col md:flex-row justify-between items-center gap-4">
						<div className="text-sm text-[#2d1609]/70">
							© {new Date().getFullYear()} 덮밥장사장. All rights
							reserved.
						</div>
						<div className="flex flex-wrap justify-center gap-6 text-sm text-[#2d1609]/70">
							<Link
								href="/privacy"
								className="hover:text-[#2d1609] transition-colors"
							>
								Privacy Policy
							</Link>
							<Link
