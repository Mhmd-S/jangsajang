...
export default function Feature() {
	return (
		<div className="flex flex-col-reverse  px-8 py-12 bg-[#8c9f82] relative overflow-hidden md:grid md:grid-cols-[45%_55%] ">
			{/* Text Content */}
			<div className="relative z-10">
				...
				<p className="text-[#00072D]/80 text-sm md:text-lg mb-8 max-w-lg">
					Discover the rich flavors and vibrant culture of Korea in
					every bite.
				</p>
				<div>
					<Button
